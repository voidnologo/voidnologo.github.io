...
# Usage: rake post title="A Title" [date="2012-02-09"] [tags=[tag1,tag2]] [category="category"] [dir="sub_directory"]
...
task :post do
  ...
  filename = File.join(CONFIG['posts'], dir, "#{date}-#{slug}.#{CONFIG['post_ext']}")
